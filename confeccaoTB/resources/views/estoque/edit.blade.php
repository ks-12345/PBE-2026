        ...
        <div class="bg-white p-6 shadow-sm sm:rounded-lg">
            <form action="{{ route('estoques.update', $estoques->id) }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="produto_id" value="{{ $estoques->produto_id }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                </div>

                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-medium text-gray-700">quantidade</label>
                        <input type="text" name="quantidade" value="{{ $estoques->quantidade }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    </div>
